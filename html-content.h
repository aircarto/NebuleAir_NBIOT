...
const char DBG_TXT_NO2PPB[] PROGMEM = "NO2 (ppb): ";
const char DBG_TXT_NO2UGM3[] PROGMEM = "NO2 (µg/m³, 25°C): ";
...
const char WEB_PAGE_FOOTER[] PROGMEM = "<br/><br/>"
		...
		"&copy; AirCarto</a>&nbsp;&nbsp("
                "<a href='https://github.com/aircarto/NebuleAir/labels/bug' target='_blank' rel='noreferrer'>" INTL_REPORT_ISSUE "</a>"

#define INTL_LANG "FR"
#define INTL_PM_SENSOR "Station de mesure NebuleAir"
...
const char INTL_NO2_PPB[] PROGMEM = "Concentration NO2 (ppb)";
const char INTL_NO2_UGM3[] PROGMEM = "Concentration NO2 (µg/m³, 25°C)";

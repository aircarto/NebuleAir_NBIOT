...
const char INTL_NO2_SENSORS[] PROGMEM = "";
...
const char INTL_ENVEANO2[] PROGMEM = "";
...
const char INTL_NBIOT_SETTINGS[] PROGMEM = "";
const char INTL_MORE_SETTINGS[] PROGMEM = "";
const char INTL_SCREENS[] PROGMEM = "";
const char INTL_SSD1306[] PROGMEM = "";
const char INTL_LED_VALUE[] PROGMEM = "";
const char INTL_LED_CONNECT[] PROGMEM = "";
